...
const MANUAL_MODE_ON = "Manual mode is now ON. Use /dcp prune, /dcp distill, or /dcp compress to trigger context tools manually.";
...
function getTriggerPrompt(tool, context, userFocus) {
    const base = tool === "prune"
